...
if [ ! -f "$1" ]; then
   ...
   echo
   echo "The name of ZIP is assumed to have clown-VERSION-DATE-TYPE-* as format"
...
# Assume clown-VERSION-DATE-TYPE-*.zip
...
adb shell "killall com.clown.updater 2>/dev/null"
adb shell "sqlite3 /data/data/com.clown.updater/databases/updates.db" \
